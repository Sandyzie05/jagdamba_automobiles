...
export const createSeedInventory = (): InventoryDocument => ({
  ...
  items: [
    createInventoryItem({
      ...
      featured: true,
      imagePath: publicAsset('images/shop-helmets.jpeg'),
    ...
    createInventoryItem({
      ...
      featured: true,
      imagePath: publicAsset('images/shop-tyres.jpeg'),
    ...
    createInventoryItem({
      ...
      featured: true,
      imagePath: publicAsset('images/shop-spare-parts.jpeg'),
    ...
    createInventoryItem({
      ...
      imagePath: publicAsset('images/shop-accessories.jpeg'),
    ...
    createInventoryItem({
      ...
      imagePath: publicAsset('images/shop-wholesale.jpeg'),
